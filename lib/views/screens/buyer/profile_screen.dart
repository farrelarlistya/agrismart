    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(child: Column(children: [
        Container(margin: const EdgeInsets.all(16), padding: const EdgeInsets.all(20), decoration: BoxDecoration(gradient: const LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [Color(0xFF1E8B4F), Color(0xFF2ECC71)]), borderRadius: BorderRadius.circular(AppDimens.radiusXL)),
          child: Column(children: [
            Stack(alignment: Alignment.bottomRight, children: [
              Container(width: 80, height: 80, decoration: BoxDecoration(color: Colors.white.withOpacity(0.3), shape: BoxShape.circle, border: Border.all(color: Colors.white, width: 2)), child: const Icon(Icons.person, color: Colors.white, size: 46)),
            ...
            const Text('Muh Hanif', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: Colors.white)),
            const Text('muh.hanif@email.com', style: TextStyle(fontSize: 12, color: Colors.white70)),
        ...
        _buildSection(context, title: 'DATA DIRI', items: [
          _ProfileItem(label: 'Nama Lengkap', value: 'Muhammad Hanif', onEdit: () {}),
          _ProfileItem(label: 'Nomor Telepon', value: '+62 812 3456 7890', onEdit: () {}),
          _ProfileItem(label: 'Email', value: 'muh.hanif@email.com', onEdit: () {}),
          _ProfileItem(label: 'Tanggal Lahir', value: '16 Mei 2005', onEdit: () {}),
          _ProfileItem(label: 'Jenis Kelamin', value: 'Laki-laki', onEdit: () {}),
        ]),
        ...
        Padding(padding: const EdgeInsets.symmetric(horizontal: 16), child: OutlinedButton(
          onPressed: () { showDialog(context: context, builder: (_) => AlertDialog(title: const Text('Hapus Akun'), content: const Text('Apakah Anda yakin ingin menghapus akun? Tindakan ini tidak dapat dibatalkan.'), actions: [TextButton(onPressed: () => Navigator.pop(context), child: const Text('Batal')), TextButton(onPressed: () => Navigator.pop(context), child: const Text('Hapus', style: TextStyle(color: AppColors.red)))])); },
